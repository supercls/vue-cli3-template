                ...
                <div class="center">
                    <div class="zf-wrapper-mom">
                        <div class="form-component">
                            <h3>二、育儿知识和行为</h3>
                            <div class="form-list">
                                <p class="form-p1">17.孩子满1岁后-3岁期间每年至少要做几次健康体检？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                                        class="requrePage2" data-name="Zjcjkjc"
                                        v-model="dataList.Zjcjkjc"
                                        :options="[{ label: '不知道',value: '1'},{ label: '2次',value: '2'},{ label: '4次',value: '3'},{ label: '6次',value: '4'}]">
                                    </mt-radio>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">18.宝宝6个月后应继续母乳喂养，可持续到宝宝几岁？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                                        class="requrePage2" data-name="Mrwydjgy"
                                        v-model="dataList.Mrwydjgy"
                                        :options="[{ label: '1岁',value: '1'},{ label: '1岁半',value: '2'},{ label: '2岁',value: '3'},{ label: '3岁',value: '4'}]">
                                    </mt-radio>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">19.下列食物中，含铁最丰富的是？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                            ...
                            <div class="form-list">
                                <p class="form-p1">20.以下哪种维生素可以促进铁的吸收？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                            ...
                            <div class="form-list">
                                <p class="form-p1">22.2岁以上的宝宝看视频、玩电子游戏等视屏时间，每天不超过多长时间？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                                         class="requrePage2" data-name="Bbkspsj"
                                        v-model="dataList.Bbkspsj"
                                        :options="[{ label: '15分钟',value: '1'},{ label: '30分钟',value: '2'},{ label: '1小时',value: '3'},{ label: '2小时',value: '4'},{ label: '不清楚',value: '5'}]">
                                    </mt-radio>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">23.以下哪种微量元素有预防龋齿作用？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                                         class="requrePage2" data-name="Nzwlysyyfqczy"
                                        v-model="dataList.Nzwlysyyfqczy"
                                        :options="[{ label: '锌',value: '1'},{ label: '铁',value: '2'},{ label: '氟 ',value: '3'},{ label: '碘',value: '4'},{ label: '不清楚',value: '5'}]">
                                    </mt-radio>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">24.关于2-3岁幼儿饮食，您认为正确的说法是（可多选）</p>
                                <div class="check-list">
                                    <super-checklist
                                        title=""
                                        class="requrePage2 moreCheck" data-name="Yeyszqdsf"
                                        v-model="dataList.Yeyszqdsf"
                                        :options="[{ label: '不能集中注意力',value: '1'},{ label: '不能按照要求做简单的事情',value: '2'},{ label: '不会用筷子吃饭 ',value: '3'},{ label: '不会扶栏杆上楼梯/台阶',value: '4'},{ label: '不知道 ',value: '5'}]">
                                    </super-checklist>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">25.2岁的宝宝出现哪些情况，提示可能存在发育异常？（可多选）</p>
                                <div class="check-list">
                                    <super-checklist
                                        title=""
                            ...
                            <div class="form-list">
                                <p class="form-p1">26.您认为家中以下哪些行为是可以预防儿童意外伤害？（可多选）</p>
                                <div class="check-list">
                                    <super-checklist
                                        title=""
                                        class="requrePage2 moreCheck" data-name="Nxxwkyyfetywsh"
                                        v-model="dataList.Nxxwkyyfetywsh"
                                        :options="[{ label: '电源进行防护',value: '1'},{ label: '热水瓶放在宝宝够不到的地方',value: '2'},{ label: '儿童床放置在窗边',value: '3'},{ label: '宝宝的洗澡水先放热水再放冷水',value: '4'},{ label: '家具边角加防护垫',value: '5'},{ label: '以上都正确',value: '6'}]">
                                    </super-checklist>
                            ...
                            <div class="form-list">
                                ...
                                <div class="form-inp">
                                    <div class="check-list">
                                        <super-checklist
                                            title=""
                                            class="requrePage2 moreCheck" data-name="Ynzffglhzcgzsw" data-next="Ynzffglhzcgzsw2"
                                            v-model="dataList.Ynzffglhzcgzsw"
                                            :options="[{ label: '拥抱或表扬孩子',value: '1'},{ label: '玩玩具或讲故事',value: '2'},{ label: '边看电视边吃 ',value: '3'},{ label: '甜食或零食作为奖励 ',value: '4'},{ label: '追着喂 ',value: '5'}]">
                                        </super-checklist>
                                        <mt-field placeholder="其他（请详述）" type="textarea" rows="3" v-model="dataList.Ynzffglhzcgzsw2"></mt-field>
                                    </div>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">29.您的宝宝开始用婴儿牙刷刷牙的时间</p>
                                <div class="form-inp">
                                     <div class="check-list">
                                        <super-checklist
                                            title=""
                                            ...
                                            class="requrePage2 moreCheck" data-name="Bbkssysj"
                                            v-model="dataList.Bbkssysj"
                                            :options="[{ label: '____个月开始开始',value: '1',picker:true,filed:dataList.Bbkssysj2,name:'dataList.Bbkssysj2',placeholder:'请选择',icon:'个月'},{ label: '还没有开始',value: '2'}]">
                                        </super-checklist>
                                    </div>
                                </div>
                            </div>
                            <div class="form-list">
                                <p class="form-p1">30.您的宝宝是否在吃维生素D或维生素AD ？</p>
                                <div class="check-list">
                                    <mt-radio
                                        title=""
                        ...
                        <div class="form-component">
                            ...
                            <div class="form-list">
                                ...
                                <div class="check-list">
                                    <super-checklist
                                        title=""
                                        class="requrePage3 moreCheck" data-name="Xydyezs"
                            ...
                            <div class="form-list">
                                ...
                                <div class="check-list">
                                    <super-checklist
                                        title=""
                                        class="requrePage3 moreCheck" data-name="Yezshqqd"
                            ...
                            <div class="form-list">
                                ...
                                <div class="check-list">
                                    <super-checklist
                                        title=""
                                        class="requrePage3 moreCheck" data-name="Xhdwljkjyxs"
                                        v-model="dataList.Xhdwljkjyxs"
                                        :max="3"            
                                        :options="[{ label: '文字形式',value: '1'},{ label: '音频',value: '2',picker:true,filed:dataList.Xhdwljkjyxs1,name:'dataList.Xhdwljkjyxs1',placeholder:'请选择音频时长'},{ label: '视频',value: '3',picker:true,filed:dataList.Xhdwljkjyxs2,name:'dataList.Xhdwljkjyxs2',placeholder:'请选择视频时长'},{ label: '微信课堂',value: '4'},{ label: '图片',value: '5'}]">
                                    </super-checklist>
                                    <mt-field placeholder="其他（请详述）" type="textarea" rows="3" v-model="dataList.Xhdwljkjyxs3"></mt-field>
                                </div>
                            </div>
                           ...
                           <div class="form-list">
                            ...
                            <div class="form-list">
                                ...
                                <div class="check-list">
                                    <super-radio
                                        title=""
                                         class="requrePage4" data-name="NfzAppddsxzs"
                ...
                <div class="bottom">
                    <div class= "pagination">
                        <div class="pag-box">
                            ...
                            <button v-if="hasReady"  class="btn" @click="submitForm('requrePage4')"   :class= "{ disabledBtn: false }">提交</button>
                        </div>
                    </div>
                </div>
            </div>
...
import {SaveQuestionair_Parent2} from '@/api/user.js'
export default {
    name:'hello',
    data(){
        return {
    ...
    methods:{
        ...
        submitForm(){
            ...
            this.$messagebox.confirm('确定执行此操作?').then(action => {
                ...
                SaveQuestionair_Parent2({...this.dataList,...this.checkObj}).then(res=>{
